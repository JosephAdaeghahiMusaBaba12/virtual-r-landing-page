  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <div className="flex justify-center my-10">
            <a href="#" className="bg-gradient-to-r from-orange-500 to-orange-800 py-4 px-3 mx-3 rounded-md">
                Start for free
            </a>
            <a href="#" className="py-4 px-3 mx-3 rounded-md border">
                Documentation
            </a>
        </div>
        <div className="flex mt-10 justify-center">
                <video autoPlay
                        muted 
                        loop 
                        className="rounded-lg w-1/3 border border-orange-700 shadow-orange-400
                        mx-2 my-4">
